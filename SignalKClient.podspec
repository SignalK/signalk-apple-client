...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of SignalKClient.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/scott@scottbender.net/SignalKClient'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'scott@scottbender.net' => 'scott@scottbender.net' }
  s.source           = { :git => 'https://github.com/scott@scottbender.net/SignalKClient.git', :tag => s.version.to_s }
